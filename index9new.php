   ...
   <div class="card">
    ...
    <form method="post">
        ...
        <div class="grid">
            ...
            <div class="form-group">
                <label>Ayah:</label>
                <select name="ayah" id="hifz-ayah-select" required>
                    <option value="">Select Surah first</option>
                </select>
            </div>
            <div class="form-group">
...
// Dynamic ayah loading for all forms
document.addEventListener('change', function(e) {
    if (e.target.name === 'surah' || e.target.id === 'theme-surah') {
        const surah = e.target.value;
        const ayahSelect = e.target.name === 'surah' ? 
            document.getElementById('ayah-select') || document.getElementById('hifz-ayah-select') :
            document.getElementById('theme-ayah');
        
        if (ayahSelect) {
            ayahSelect.innerHTML = '<option value="">Loading...</option>';
            
            // You can customize max ayahs per surah
            const maxAyahs = getMaxAyahs(parseInt(surah));
